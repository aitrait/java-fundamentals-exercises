...
public class CrazyGenerics {
    ...
    interface ComparableCollection<E> extends Collection<E>, Comparable<Collection<?>> {
        ...
        @Override
        default int compareTo(Collection<?> obj) {
            return Integer.compare(this.size(), obj.size());
        }
    }

    static class CollectionUtil {
        static final Comparator<BaseEntity> CREATED_ON_COMPARATOR = Comparator.comparing((T t) -> BaseEntity.getCreatedOn(t));
